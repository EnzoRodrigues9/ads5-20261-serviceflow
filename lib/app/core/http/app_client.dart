...
class AppClient {
  ...
  /// CORREÇÃO: baseUrl aponta para a raiz do Supabase.
  /// Os endpoints dos providers já incluem '/rest/v1/...' completo.
  BaseOptions _createBaseOptions() {
    return BaseOptions(
      baseUrl: AppConfig.supabaseUrl, // ← era '${AppConfig.supabaseUrl}/rest/v1'
  ...
  /// CORREÇÃO: caminho correto sem duplicar /rest/v1
