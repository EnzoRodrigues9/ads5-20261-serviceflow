  ...
  Future<void> salvarOS() async {
    try {
      ...
      final ordem = OrdemServico(
        ...
        itens: servicosSelecionados.map(
          (servico) {
            return OsItem(
              osId: widget.ordemServico?.id ?? 0,
      ...
      if (widget.ordemServico == null) {
        await service.create(ordem);
      } else {
        await service.update(ordem);
      }
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            CustomListCard(
              leading: CircleAvatar(
                backgroundColor: colors.tertiary.withOpacity(
                  0.12,
                ),
                child: Icon(
              ...
              subtitle: Column(
                children: [
                  ...
                  ...servicos.map(
                    (servico) {
                      final selecionado = servicosSelecionados.contains(
                        servico,
                      );
